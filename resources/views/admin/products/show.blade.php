            ...
            <div class="col-md-4 col-lg-3">
                ...
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <a href="{{asset($product->caracteristicas)}}" target="_blank" class=""><i class="fa fa-file-pdf-o"></i> Descargar ficha tecnica</a> <br>

                        <a href="{{asset('administracion/galerias/'.$product->slug)}}"  class=""><i class="fa fa-camera"></i> Galerias</a> <br>
